...
public class FindMaxCommandTest {
    private final static String TEST_PARAM_NAME_UNIT = "Unit";
    private final static String TEST_PARAM_NAME_PREVIOUS = "Previous";
    ...
    public void shouldGetExecuteWithWrongPathParam_andThrowRunTimeException() {
        Assertions.assertThrows(RuntimeException.class, () -> command.execute(TEST_PARAM_NAME_UNIT, TEST_WRONG_FILE_PATH, parser));
    }
    ...
    public void shouldGetExecuteWithWrongParamNameValue_andThrowIllegalArgumentException() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> command.execute("WrongName", TEST_FILE_PATH, parser));
    }
    ...
    public void shouldGetExecuteWithMockParser_AndGetVerifyTrue() {
        ...
        command.execute(TEST_PARAM_NAME_PREVIOUS, TEST_FILE_PATH, parserMock);
